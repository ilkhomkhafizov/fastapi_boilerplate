...
class PostRepository:
    ...
    async def get_by_id(self, post_id: UUID, with_author: bool = True) -> Optional[Post]:
        """
        Get post by ID.
    ...
    async def get_by_slug(self, slug: str, with_author: bool = True) -> Optional[Post]:
        """
        Get post by slug.
    ...
    async def get_post_stats(self, user_id: Optional[UUID] = None) -> dict:
        """
        Get post statistics.
