...
class TestUsers:
    ...
    async def test_get_user_profile(self, client: AsyncClient, test_user: User, auth_headers: dict):
    ...
    async def test_list_users_admin_only(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_list_users_as_admin(
        self, client: AsyncClient, admin_auth_headers: dict, test_user: User, test_admin: User,
    ):
